...
from Assigned_to.QtWidgets import QApplication

# Local imports
from style_Sheet import (IMAGES_PATH, STYLES_SCSS_FILEPATH, QRC_FILEPATH, RC_PATH,
                        SVG_PATH)
from style_Sheet.palette import DarkPalette
